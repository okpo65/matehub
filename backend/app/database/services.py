...
from .schemas import (
    CharacterWithStories, StoryWithCharacter, StoryWithRelations,
    CharacterDetailResponse, StoryDetailResponse, StoryChatHistoryWithRelations, CharacterImage, CharacterProfileResponse
)
...
class CharacterService:
    ...
    def get_characters(self, limit: Optional[int] = None, include_inactive: bool = False) -> List[CharacterWithStories]:
        ...
        return [CharacterWithStories.model_validate(char) for char in characters]

    def get_all_characters(self, limit: Optional[int] = None) -> List[CharacterWithStories]:
    ...
    def get_character_with_stories(self, character_id: int) -> Optional[CharacterWithStories]:
        ...
        if character:
            return CharacterWithStories.model_validate(character)
        return None
    ...
    def get_character_photos(self, character_id: int, active_only: bool = True) -> List[CharacterImage]:
        ...
        return [CharacterImage.model_validate(img) for img in images]

    def get_popular_characters(self, limit: int = 10) -> List[CharacterWithStories]:
...
class StoryService:
    ...
    def get_story_with_character(self, story_id: int) -> Optional[StoryWithCharacter]:
        ...
        if story:
            return StoryWithCharacter.model_validate(story)
        return None
    ...
    def get_stories_by_character(self, character_id: int) -> List[StoryWithCharacter]:
        ...
        return [StoryWithCharacter.model_validate(story) for story in stories]

    def get_user_story_matches(self, user_id: int) -> List[StoryWithCharacter]:
        ...
        return [StoryWithCharacter.model_validate(match.story) for match in matches]
...
class ChatHistoryService:
    ...
    def get_chat_history_with_relations(
    ...
    ) -> List[StoryChatHistoryWithRelations]:
        ...
        return [StoryChatHistoryWithRelations.model_validate(msg) for msg in messages]
